export const help = {
  ...
  a2: 'Instellingen → Servers → Server toevoegen. Voer de URL in (bijv. http://192.168.1.100:4533), gebruikersnaam en wachtwoord. Psysonic test de verbinding voor het opslaan — bij een fout wordt niets opgeslagen. U kunt zoveel servers toevoegen als u wilt en meerdere daarvan tegelijk doorbladeren — zie „Kan ik meerdere servers tegelijk gebruiken?” hieronder.',
  ...
  q46: 'Kan ik meerdere servers tegelijk gebruiken?',
  a46: 'Ja. Instellingen → Servers bewaart alle profielen, en het bibliotheekbereik in de zijbalk bepaalt welke u doorbladert — kies muziekmappen van meerdere servers tegelijk en Psysonic voegt ze samen tot één catalogus, in de prioriteitsvolgorde die u instelt. Hoofdpodium, Alle albums, Artiesten, Componisten, Genres, Favorieten, Playlists, Mappenverkenner, de zoekfunctie, Meest gespeeld en Statistieken bundelen de gekozen servers, en muziek die u op meerdere servers heeft verschijnt één keer in plaats van per server. Eén wachtrij mag nummers van verschillende servers bevatten; elk nummer haalt stream, hoes, songtekst en ReplayGain op bij de server die het bezit.',
  ...
  a5: 'Gapless buffert het volgende nummer vooraf zodat er nul stilte tussen de nummers zit (ideaal voor live-albums en DJ-mixen). Crossfade vervaagt het huidige nummer terwijl het volgende invaagt over 1–10 s (ideaal voor gemixte mixen). AutoDJ is crossfade die de muziek volgt: het snijdt de stilte aan de randen weg en haalt de overlap uit de inhoudsanalyse, zodat de overgang valt waar de nummers echt eindigen en beginnen. Slechts één van de drie kan actief zijn — een inschakelen schakelt de andere uit. Wisselen kan via de wachtrijbalk, configureren in Instellingen → Audio.',
  q6: 'Wat is de Infinite Queue?',
  a6: 'Wanneer de wachtrij leegloopt en Herhalen uit staat, voegt Psysonic stilletjes vergelijkbare/willekeurige nummers uit uw bibliotheek toe zodat het afspelen nooit stopt. Auto-toegevoegde nummers verschijnen onder een "— Automatisch toegevoegd —" scheidingslijn. Schakelen via het oneindigheidspictogram in de wachtrijbalk of in de mini-speler.',
  ...
  q47: 'Tijdlijnweergave van de wachtrij en „Vanaf hier afspelen”?',
  a47: 'Instellingen → Personalisatie biedt een tijdlijnweergave voor de wachtrij: het huidige nummer blijft bovenaan, wat al gespeeld is schuift erboven en wat komt staat eronder. Klik met rechts op een eerdere regel en kies „Vanaf hier afspelen” om dat moment terug te halen — dat nummer, alle latere geschiedenisregels en de bestaande Straks-lijst, in hun oorspronkelijke volgorde en van de servers waar ze vandaan kwamen.',
  s3: 'Audiotools',
  q9: 'Replay Gain modi?',
  ...
  q48: 'Kan ik de streamingkwaliteit begrenzen?',
  a48: 'Per serveradres, onder Instellingen → Servers bij het bewerken van een opgeslagen Navidrome-profiel. Kies geen limiet of een plafond van 320 tot 64 kbps, met Auto, MP3, Opus of AAC als doelformaat; Navidrome transcodeert de live stream dan mee. Omdat de instelling aan het adres hangt, kunnen een lokaal en een publiek adres verschillende profielen gebruiken en volgt het afspelen het adres waarmee u verbonden bent. Offline downloads, gesynchroniseerde favorieten en de hot cache halen altijd het originele bestand, dus opgeslagen muziek houdt zijn volle kwaliteit.',
  ...
  q49: 'Raster of tabel op de albumpagina\'s?',
  a49: 'Alle albums, Nieuw en Lossless kunnen wisselen tussen het kaartraster en een tabel, en elke pagina onthoudt zijn eigen keuze. De tabel toont hoes, titel, artiest, aantal nummers, jaar, duur en de datum waarop het album is toegevoegd, sorteert op titel of jaar via de kolomkoppen en laat kolommen van rechts vallen als het venster smaller wordt.',
  q50: 'Mijn playlists en die van anderen?',
  a50: 'Een Subsonic-server levert uw eigen playlists en alle openbare playlists van iedereen in één ongedeelde lijst. De Playlists-pagina kan die splitsen in uw eigen, de playlists die u deelt en die anderen met u delen — de schakelaar verschijnt zodra er op de server echt iets gedeeld is en werkt samen met de mappenweergave en het zoekveld. De zijbalk toont van elke playlist de hoes en het aantal nummers; zowel de zijbalk als de pagina zijn te sorteren op naam, aanmaakdatum of aantal nummers.',
  q51: 'Wat is de Componisten-pagina?',
  a51: 'Componisten (zijbalk) toont de componisten uit de tags van uw bibliotheek en opent per componist een pagina met de werken waarop hij vermeld staat. Ze volgt hetzelfde bibliotheekbereik als de rest van de app, dus met meerdere servers geselecteerd worden ze tot één lijst samengevoegd.',
  s5: 'Songteksten',
  ...
  q52: 'Audiovisualisatie?',
  a52: 'Instellingen → Weergave → Visualizer zet hem aan voor Nu bezig, voor de volledig scherm-speler of voor allebei — elk heeft zijn eigen schakelaar. Kies spectrum, oscilloscoop, radiaal of stereoveld, neem de kleuren uit de hoes of uit uw thema en stel gevoeligheid, respons, beeldsnelheid en piekmarkeringen in. Internetradio hoort erbij zolang de equalizergraaf ervan actief is.',
  q53: 'Waar vind ik meer thema\'s?',
  a53: 'Instellingen → Thema\'s bevat de Theme Store: die toont thema\'s van de community, laat van elk een voorbeeld zien en installeert, werkt bij of verwijdert ze ter plekke. Catalogus en voorbeelden worden van GitHub geladen en er worden geen persoonlijke gegevens verzonden. Geïnstalleerde thema\'s staan daarna naast de meegeleverde in dezelfde keuzelijst.',
  q54: 'Kan ik de achtergrondafbeeldingen wijzigen?',
  a54: 'Onder Instellingen → Integraties → Achtergronden bepaalt u welke afbeelding het Hoofdpodium, de kop van de artiestpagina en de volledig scherm-speler gebruiken, en in welke volgorde de bronnen worden geprobeerd — banner, fanart-artiestafbeelding of de afbeelding van uw server. Sleep om te herschikken, of zet een bron uit om hem over te slaan.',
  s8: 'Power User',
