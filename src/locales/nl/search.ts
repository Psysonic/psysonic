export const search = {
  ...
  scopeFavoritesPlaceholder: 'Favorieten doorzoeken…',
  scopeFavoritesBadgeTooltip: 'Klik — verwijderen',
  scopeFavoritesGhostTooltip: 'Klik — alleen op deze pagina zoeken',
