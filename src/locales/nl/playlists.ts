export const playlists = {
  ...
  smartReadOnlyEmpty: 'Deze smart playlist heeft geen overeenkomende nummers.',
  title: 'Playlists',
  ...
  refreshSmart: 'Smart playlist vernieuwen',
  refreshSmartSuccess: 'Smart playlist vernieuwd',
  refreshSmartError: 'Smart playlist kon niet worden vernieuwd',
