export const settings = {
  ...
  discordCoverDesc: 'Wat je Discord-profiel als albumhoes mag tonen. ‘Geen (alleen app-pictogram)’ publiceert niets. De andere opties sturen afbeeldings-URL’s naar de afbeeldingsproxy van Discord — wie je profiel bekijkt, kan het openbare adres van je server zien, en serverhoezen vereisen een openbaar bereikbare server. De hoesbronnen in de app hieronder staan daar los van.',
  discordCoverNone: 'Geen (alleen app-icoon)',
  discordCoverServer: 'App-bronnen volgen',
  discordCoverApple: 'Alleen externe bronnen (geen server-URL’s)',
  coverSourceSectionTitle: 'Albumhoezen',
  coverSourceTitle: 'Bronnen voor albumhoezen',
  coverSourceDesc: 'Waar albumhoezen vandaan komen als de server er geen heeft. De volgorde loopt van boven naar beneden; de eerste ingeschakelde bron die een afbeelding teruggeeft, wint. Sleep om te herschikken of schakel een bron uit om die over te slaan.',
  coverSourceServer: 'Server (albuminfo)',
  ...
  lyricsPronunciationTitle: 'Uitspraak',
  lyricsRomanization: 'Uitspraak en Japanse romaji',
  lyricsRomanizationDesc: 'Toont door de server geleverde uitspraak onder de songtekst, of maakt lokaal Hepburn-romaji voor Japanse tekst.',
  lyricsWordHighlightTitle: 'Woordmarkering',
  lyricsWordHighlightStep: 'Stapsgewijs',
  ...
  favoritesLayoutTitle: 'Secties favorietenpagina',
  favoritesLayoutDesc: 'Versleep om te herschikken, schakel om individuele secties van de favorietenpagina te verbergen. Secties zonder favorieten worden automatisch overgeslagen.',
  favoritesLayoutReset: 'Standaard herstellen',
  ...
  smartPlaylistCustomFieldsTitle: 'Aangepaste velden voor smart playlists',
  smartPlaylistCustomFieldsDesc: 'Voeg serverspecifieke tags en rollen toe aan de veldkiezer voor Geavanceerde smart playlists. Ingebouwde Navidrome-velden en standaardtags uit mappings.yaml staan al in de lijst. Vereist Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Aangepaste velden',
  smartPlaylistCustomFieldsEmpty: 'Er zijn nog geen aangepaste velden toegevoegd.',
  smartPlaylistCustomFieldsInvalid: 'Gebruik een naam die met een letter begint en geen spaties bevat (bijvoorbeeld mood_energy). Gereserveerde namen zoals sort of limit kunnen niet worden gebruikt.',
  smartPlaylistCustomFieldsDuplicate: 'Dat veld staat al in de lijst.',
  smartPlaylistCustomFieldsRemove: '{{name}} verwijderen',
