export const deviceSync = {
  ...
  transcodeBitrateServer: 'Standaard van server',
  transcodeBitrateValue: '{{kbps}} kbps',
  transcodeHint: 'Je server converteert de bestanden tijdens het synchroniseren, dus het formaat moet in de transcodeerinstellingen zijn ingeschakeld. Tags blijven behouden, ingesloten albumhoezen mogelijk niet. MP3 werkt met de meeste DJ-software.',
