export const settings = {
  ...
  miniPlayerCustomTitlebar: 'Скрыть заголовок окна',
  miniPlayerCustomTitlebarDesc: 'Мини-плеер использует собственную тонкую полосу вместо системной. Свернуть и восстановить исчезают — окно предлагает то же самое.',
  ...
  discordCoverDesc: 'Что ваш профиль Discord может показывать в качестве обложки. «Нет (только значок приложения)» не публикует ничего. Остальные варианты передают ссылки на изображения в прокси изображений Discord: тот, кто смотрит ваш профиль, может увидеть публичный адрес вашего сервера, а обложки с сервера требуют публично доступного сервера. Источники обложек в приложении, ниже, от этого не зависят.',
  discordCoverNone: 'Нет (только иконка приложения)',
  discordCoverServer: 'Следовать источникам приложения',
  discordCoverApple: 'Только внешние источники (без ссылок на сервер)',
  coverSourceSectionTitle: 'Обложки альбомов',
  coverSourceTitle: 'Источники обложек',
  coverSourceDesc: 'Откуда берутся обложки, если на сервере их нет. Порядок — сверху вниз; побеждает первый включённый источник, вернувший изображение. Перетащите, чтобы изменить порядок, или отключите источник, чтобы пропустить его.',
  coverSourceServer: 'Сервер (сведения об альбоме)',
  ...
  lyricsRomanization: 'Произношение и японская ромадзи',
  lyricsRomanizationDesc: 'Показывать под текстом произношение с сервера или локально создавать ромадзи по системе Хэпбёрна для японского текста.',
  lyricsWordHighlightTitle: 'Подсветка слов',
  lyricsWordHighlightStep: 'По шагам',
  lyricsWordHighlightStepDesc: 'Слово окрашивается целиком при достижении его таймкода.',
  lyricsWordHighlightSmooth: 'Плавно',
  lyricsWordHighlightSmoothDesc: 'Текущее слово постепенно заполняется цветом в течение его длительности.',
  lyricsWordHighlightFlowing: 'Только заливка',
  lyricsWordHighlightFlowingDesc: 'Постепенно заполняет текущее слово цветом без мгновенного свечения всего слова.',
  ...
  playQueueSyncTitle: 'Синхронизация очереди',
  playQueueSyncDesc: 'Синхронизирует очередь и позицию воспроизведения этого устройства с сервером для продолжения на другом устройстве. Отключите, чтобы очередь оставалась локальной.',
  ...
  favoritesLayoutTitle: 'Разделы страницы «Избранное»',
  favoritesLayoutDesc: 'Перетаскивайте, чтобы изменить порядок, переключайте, чтобы скрыть отдельные разделы страницы «Избранное». Разделы без избранного пропускаются автоматически.',
  favoritesLayoutReset: 'Сбросить',
  ...
  backupCredentialsNoticeTitle: 'Резервные копии содержат пароли',
  backupCredentialsNoticeBody: 'Резервные копии настроек и полные копии сохраняют пароли серверов и ключи scrobbler в виде читаемого текста — именно это позволяет восстановлению вернуть входы. Любой, кто откроет файл, сможет их прочитать, поэтому храните его в надёжном месте и не передавайте другим.',
  backupExport: 'Экспорт настроек',
  backupExportDesc:
    'Сохраняет настройки, серверы, Last.fm, тему, EQ и горячие клавиши в файл .psybkp. Пароли в открытом виде — храните файл в безопасности. Загруженная музыка, кэш и подключённое устройство синхронизации не включаются.',
  ...
  queueRowFavoriteButton: 'Кнопка избранного в очереди',
  queueRowFavoriteButtonSub: 'Показывать сердечко в конце каждой строки очереди, чтобы добавить трек в избранное, не покидая очередь.',
