export const settings = {
  ...
  discordCoverDesc: 'What your Discord profile may show as album artwork. "None (app icon only)" publishes nothing. The other options publish artwork URLs to Discord\'s image proxy — anyone viewing your profile may see your server\'s public address, and server covers need a publicly reachable server. The in-app album cover sources below are separate.',
  discordCoverNone: 'None (app icon only)',
  discordCoverServer: 'Follow in-app sources',
  discordCoverApple: 'External sources only (no server URLs)',
  ...
  lyricsPronunciationTitle: 'Pronunciation',
  lyricsRomanization: 'Pronunciation and Japanese romaji',
  lyricsRomanizationDesc: 'Show server-provided pronunciation beneath lyrics, or generate Hepburn romaji locally for Japanese text.',
  lyricsWordHighlightTitle: 'Word highlighting',
  lyricsWordHighlightStep: 'Step',
  ...
  smartPlaylistCustomFieldsTitle: 'Smart Playlist Custom Fields',
  smartPlaylistCustomFieldsDesc: 'Add server-specific tags and roles for the Advanced smart-playlist field picker. Built-in Navidrome fields and default mappings.yaml tags are already listed. Requires Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Custom fields',
  smartPlaylistCustomFieldsEmpty: 'No custom fields added yet.',
  smartPlaylistCustomFieldsInvalid: 'Use a letter-first name without spaces (for example mood_energy). Reserved names like sort or limit cannot be used.',
  smartPlaylistCustomFieldsDuplicate: 'That field is already in the list.',
  smartPlaylistCustomFieldsRemove: 'Remove {{name}}',
  ...
  playQueueSyncTitle: 'Play queue sync',
  playQueueSyncDesc: 'Keep this device\'s queue and playback position in sync with the server for cross-device handoff. Turn it off to keep this device\'s queue local.',
  integrationsPrivacyBody: 'All integrations on this tab are <strong>optional</strong> and send data to external services or to your Navidrome server when enabled. Last.fm receives your listening history, Discord shows the currently playing track in your profile, Bandsintown is queried per artist to fetch tour dates, and the Now-Playing share publishes your current track to other users of your Navidrome server. If you don\'t want any of this, simply leave the corresponding section disabled.',
  ...
  favoritesLayoutTitle: 'Favorites page sections',
  favoritesLayoutDesc: 'Drag to reorder, toggle to hide individual sections of the Favorites page. Sections without favorites are skipped automatically.',
  favoritesLayoutReset: 'Reset to default',
  ...
  backupExportDesc: 'Saves all settings, server profiles, Last.fm config, theme, EQ and keybindings to a .psybkp file. Passwords are stored in plaintext — keep the file secure. Downloaded music, caches and a connected sync device are not included.',
