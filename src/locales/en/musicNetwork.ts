export const musicNetwork = {
  ...
  owedPlays_one: '{{count}} play waiting to be sent',
  owedPlays_other: '{{count}} plays waiting to be sent',
  owedPlaysHelp: 'Kept because the service could not be reached. Sent automatically once it responds again.',
