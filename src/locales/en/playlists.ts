export const playlists = {
  ...
  smartReadOnlyEmpty: 'This smart playlist has no matching tracks.',
  title: 'Playlists',
  ...
  refreshSmart: 'Refresh smart playlist',
  refreshSmartSuccess: 'Smart playlist refreshed',
  refreshSmartError: 'Could not refresh smart playlist',
