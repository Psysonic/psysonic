export const settings = {
  ...
  miniPlayerCustomTitlebar: 'Ocultar la barra de título de la ventana',
  miniPlayerCustomTitlebarDesc: 'El mini reproductor usa su propia barra estrecha en lugar de la del sistema. Minimizar y restaurar desaparecen: la ventana ya ofrece ambos.',
  ...
  discordCoverDesc: 'Lo que tu perfil de Discord puede mostrar como carátula. «Ninguna (solo icono de la app)» no publica nada. Las demás opciones envían las URL de las imágenes al proxy de imágenes de Discord: quien vea tu perfil podría ver la dirección pública de tu servidor, y las carátulas del servidor requieren un servidor accesible públicamente. Las fuentes de carátulas de la aplicación, más abajo, son independientes.',
  discordCoverNone: 'Ninguna (solo icono de la app)',
  discordCoverServer: 'Seguir las fuentes de la app',
  discordCoverApple: 'Solo fuentes externas (sin URL del servidor)',
  coverSourceSectionTitle: 'Carátulas de álbum',
  coverSourceTitle: 'Fuentes de carátulas',
  coverSourceDesc: 'De dónde salen las carátulas cuando el servidor no tiene ninguna. El orden va de arriba abajo; gana la primera fuente activa que devuelva una imagen. Arrastra para reordenar o desactiva una fuente para omitirla.',
  coverSourceServer: 'Servidor (información del álbum)',
  ...
  lyricsPronunciationTitle: 'Pronunciación',
  lyricsRomanization: 'Pronunciación y rōmaji japonés',
  lyricsRomanizationDesc: 'Muestra debajo de la letra la pronunciación proporcionada por el servidor o genera localmente rōmaji Hepburn para texto japonés.',
  lyricsWordHighlightTitle: 'Resaltado de palabras',
  lyricsWordHighlightStep: 'Por pasos',
  lyricsWordHighlightStepDesc: 'Resalta cada palabra por completo al alcanzar su marca de tiempo.',
  lyricsWordHighlightSmooth: 'Suave',
  lyricsWordHighlightSmoothDesc: 'Rellena gradualmente la palabra actual durante su duración sincronizada.',
  lyricsWordHighlightFlowing: 'Solo relleno',
  lyricsWordHighlightFlowingDesc: 'Rellena gradualmente la palabra actual sin iluminar primero la palabra completa.',
  ...
  smartPlaylistCustomFieldsTitle: 'Campos personalizados de listas inteligentes',
  smartPlaylistCustomFieldsDesc: 'Añade etiquetas y roles específicos del servidor al selector de campos del modo Avanzado. Los campos integrados de Navidrome y las etiquetas predeterminadas de mappings.yaml ya aparecen en la lista. Requiere Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Campos personalizados',
  smartPlaylistCustomFieldsEmpty: 'Aún no se han añadido campos personalizados.',
  smartPlaylistCustomFieldsInvalid: 'Usa un nombre sin espacios que empiece por una letra (por ejemplo, mood_energy). No se pueden usar nombres reservados como sort o limit.',
  smartPlaylistCustomFieldsDuplicate: 'Ese campo ya está en la lista.',
  smartPlaylistCustomFieldsRemove: 'Eliminar {{name}}',
  ...
  playQueueSyncTitle: 'Sincronizar la cola de reproducción',
  playQueueSyncDesc: 'Sincroniza la cola y la posición de reproducción de este dispositivo con el servidor para continuar en otro dispositivo. Desactívalo para mantener la cola local.',
  integrationsPrivacyBody: 'Todas las integraciones de esta pestaña son <strong>opcionales</strong> y, una vez activadas, envían datos a servicios externos o a tu servidor Navidrome. Last.fm recibe tu historial de escucha, Discord muestra la pista actual en tu perfil, Bandsintown se consulta por artista para obtener fechas de gira, y la compartición «En reproducción» publica tu pista actual para otros usuarios de tu servidor Navidrome. Si no quieres nada de esto, simplemente deja desactivada la sección correspondiente.',
  ...
  favoritesLayoutTitle: 'Secciones de la página de favoritos',
  favoritesLayoutDesc: 'Arrastra para reordenar, alterna para ocultar secciones individuales de la página de favoritos. Las secciones sin favoritos se omiten automáticamente.',
  favoritesLayoutReset: 'Restablecer a predeterminado',
  ...
  albumHeaderLayoutTitle: 'Diseño de la página del álbum',
