export const playlists = {
  ...
  smartReadOnlyEmpty: 'Esta lista inteligente no tiene pistas coincidentes.',
  ...
  refreshSmart: 'Actualizar lista inteligente',
  refreshSmartSuccess: 'Lista inteligente actualizada',
  refreshSmartError: 'No se pudo actualizar la lista inteligente',
