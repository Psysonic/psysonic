export const settings = {
  ...
  discordCoverDesc: 'Ce poate afișa profilul tău Discord drept copertă. „Niciuna (doar pictograma aplicației)" nu publică nimic. Celelalte opțiuni trimit adresele imaginilor către proxy-ul de imagini al Discord — cine îți vede profilul poate vedea adresa publică a serverului tău, iar copertele de pe server necesită un server accesibil public. Sursele de coperte din aplicație, mai jos, sunt separate.',
  discordCoverNone: 'Niciuna (doar iconița aplicației)',
  discordCoverServer: 'Urmează sursele aplicației',
  discordCoverApple: 'Doar surse externe (fără adrese de server)',
  coverSourceSectionTitle: 'Coperte de album',
  coverSourceTitle: 'Surse pentru coperte',
  coverSourceDesc: 'De unde provin copertele când serverul nu are niciuna. Ordinea este de sus în jos; câștigă prima sursă activată care returnează o imagine. Trage pentru a reordona sau dezactivează o sursă pentru a o sări.',
  coverSourceServer: 'Server (informații despre album)',
  ...
  lyricsPronunciationTitle: 'Pronunție',
  lyricsRomanization: 'Pronunție și romaji japonez',
  lyricsRomanizationDesc: 'Afișează sub versuri pronunția oferită de server sau generează local romaji Hepburn pentru textul japonez.',
  lyricsWordHighlightTitle: 'Evidențierea cuvintelor',
  lyricsWordHighlightStep: 'În pași',
  ...
  smartPlaylistCustomFieldsTitle: 'Câmpuri personalizate pentru playlisturi inteligente',
  smartPlaylistCustomFieldsDesc: 'Adaugă etichete și roluri specifice serverului pentru selectorul de câmpuri al editorului Avansat de playlisturi inteligente. Câmpurile Navidrome încorporate și etichetele implicite din mappings.yaml sunt deja listate. Necesită Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Câmpuri personalizate',
  smartPlaylistCustomFieldsEmpty: 'Nu a fost adăugat încă niciun câmp personalizat.',
  smartPlaylistCustomFieldsInvalid: 'Folosește un nume fără spații, care începe cu o literă (de exemplu mood_energy). Numele rezervate precum sort sau limit nu pot fi folosite.',
  smartPlaylistCustomFieldsDuplicate: 'Câmpul este deja în listă.',
  smartPlaylistCustomFieldsRemove: 'Elimină {{name}}',
  ...
  favoritesLayoutTitle: 'Secțiunile paginii Favorite',
  favoritesLayoutDesc: 'Trage pentru a reordona, comută pentru a ascunde secțiuni individuale ale paginii Favorite. Secțiunile fără favorite sunt ignorate automat.',
  favoritesLayoutReset: 'Resetează la implicit',
  ...
  backupExportDesc: 'Salvează toate setările, profilele de server, configurări Last.fm, teme, EQ și combinații de taste către un fișier .psybkp. Parolele sunt stocate ca text — păstrează fișierul în siguranță. Muzica descărcată, memoriile cache și un dispozitiv de sincronizare conectat nu sunt incluse.',
