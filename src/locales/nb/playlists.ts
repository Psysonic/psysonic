export const playlists = {
  ...
  smartReadOnlyEmpty: 'Denne smartspillelisten har ingen samsvarende spor.',
  title: 'Spillelister',
  ...
  refreshSmart: 'Oppdater smartspilleliste',
  refreshSmartSuccess: 'Smartspillelisten er oppdatert',
  refreshSmartError: 'Kunne ikke oppdatere smartspillelisten',
