export const deviceSync = {
  ...
  transcodeBitrateServer: 'Serverens standard',
  transcodeBitrateValue: '{{kbps}} kbps',
  transcodeHint: 'Serveren konverterer filene under synkronisering, så formatet må være aktivert i omkodingsinnstillingene. Tagger beholdes, innebygd omslagsbilde kanskje ikke. MP3 fungerer med de fleste DJ-programmer.',
