export const settings = {
  ...
  discordCoverDesc: 'Hva Discord-profilen din kan vise som albumbilde. «Ingen (kun appikon)» publiserer ingenting. De andre valgene sender bilde-URL-er til Discords bildeproxy — de som ser profilen din, kan se den offentlige adressen til serveren din, og serverbilder krever en offentlig tilgjengelig server. Albumbildekildene i appen nedenfor er uavhengige av dette.',
  discordCoverNone: 'Ingen (kun app-ikon)',
  discordCoverServer: 'Følg kildene i appen',
  discordCoverApple: 'Bare eksterne kilder (ingen server-URL-er)',
  coverSourceSectionTitle: 'Albumbilder',
  coverSourceTitle: 'Kilder for albumbilder',
  coverSourceDesc: 'Hvor albumbilder hentes fra når serveren ikke har noen. Rekkefølgen går ovenfra og ned; den første aktiverte kilden som gir et bilde, vinner. Dra for å endre rekkefølge, eller slå av en kilde for å hoppe over den.',
  ...
  lyricsPronunciationTitle: 'Uttale',
  lyricsRomanization: 'Uttale og japansk romaji',
  lyricsRomanizationDesc: 'Viser uttale fra serveren under sangteksten, eller lager Hepburn-romaji lokalt for japansk tekst.',
  lyricsWordHighlightTitle: 'Ordmarkering',
  lyricsWordHighlightStep: 'Trinnvis',
  ...
  favoritesLayoutTitle: 'Seksjoner på favorittsiden',
  favoritesLayoutDesc: 'Dra for å omorganisere, veksle for å skjule individuelle seksjoner av favorittsiden. Seksjoner uten favoritter hoppes over automatisk.',
  favoritesLayoutReset: 'Tilbakestill til standard',
  ...
  smartPlaylistCustomFieldsTitle: 'Egendefinerte felt for smartspillelister',
  smartPlaylistCustomFieldsDesc: 'Legg til serverspesifikke tagger og roller i feltvelgeren for Avansert smartspilleliste. Innebygde Navidrome-felt og standardtagger fra mappings.yaml er allerede oppført. Krever Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Egendefinerte felt',
  smartPlaylistCustomFieldsEmpty: 'Ingen egendefinerte felt er lagt til ennå.',
  smartPlaylistCustomFieldsInvalid: 'Bruk et navn som begynner med en bokstav og ikke inneholder mellomrom (for eksempel mood_energy). Reserverte navn som sort eller limit kan ikke brukes.',
  smartPlaylistCustomFieldsDuplicate: 'Feltet finnes allerede i listen.',
  smartPlaylistCustomFieldsRemove: 'Fjern {{name}}',
  tabAudio: 'Lyd',
  tabInput: 'Inndata',
