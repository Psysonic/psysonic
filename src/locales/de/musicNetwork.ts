export const musicNetwork = {
  ...
  owedPlays_one: '{{count}} Wiedergabe wartet auf Übertragung',
  owedPlays_other: '{{count}} Wiedergaben warten auf Übertragung',
  owedPlaysHelp: 'Aufgehoben, weil der Dienst nicht erreichbar war. Wird automatisch gesendet, sobald er wieder antwortet.',
