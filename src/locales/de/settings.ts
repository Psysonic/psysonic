export const settings = {
  ...
  discordCoverDesc: 'Was dein Discord-Profil als Albumcover zeigen darf. „Keins (nur App-Symbol)" veröffentlicht nichts. Die anderen Optionen übermitteln Bild-URLs an den Bildproxy von Discord — wer dein Profil ansieht, sieht dabei möglicherweise die öffentliche Adresse deines Servers, und Server-Cover brauchen einen öffentlich erreichbaren Server. Die App-internen Coverquellen weiter unten sind davon getrennt.',
  discordCoverNone: 'Keine (nur App-Symbol)',
  discordCoverServer: 'App-Quellen folgen',
  discordCoverApple: 'Nur externe Quellen (keine Server-URLs)',
  coverSourceSectionTitle: 'Albumcover',
  coverSourceTitle: 'Quellen für Albumcover',
  coverSourceDesc: 'Woher Albumcover kommen, wenn der Server keines hat. Reihenfolge von oben nach unten; die erste aktive Quelle mit Treffer gewinnt. Zum Umsortieren ziehen oder eine Quelle abschalten, um sie zu überspringen.',
  ...
  lyricsPronunciationTitle: 'Aussprache',
  lyricsRomanization: 'Aussprache und japanisches Romaji',
  lyricsRomanizationDesc: 'Zeigt eine vom Server bereitgestellte Aussprache unter den Lyrics oder erzeugt lokal Hepburn-Romaji für japanischen Text.',
  lyricsWordHighlightTitle: 'Worthervorhebung',
  lyricsWordHighlightStep: 'Schrittweise',
  lyricsWordHighlightStepDesc: 'Hebt jedes Wort vollständig hervor, sobald sein Zeitstempel erreicht ist.',
  lyricsWordHighlightSmooth: 'Fließend',
  lyricsWordHighlightSmoothDesc: 'Füllt das aktuelle Wort während seiner zeitlichen Dauer allmählich mit Farbe.',
  lyricsWordHighlightFlowing: 'Nur Füllung',
  lyricsWordHighlightFlowingDesc: 'Füllt das aktuelle Wort allmählich, ohne zuerst das ganze Wort hervorzuheben.',
  ...
  smartPlaylistCustomFieldsTitle: 'Benutzerdefinierte Smart-Playlist-Felder',
  smartPlaylistCustomFieldsDesc: 'Füge serverspezifische Tags und Rollen für die Feldauswahl im erweiterten Smart-Playlist-Modus hinzu. Eingebaute Navidrome-Felder und die Standard-Tags aus mappings.yaml sind bereits aufgeführt. Erfordert Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Benutzerdefinierte Felder',
  smartPlaylistCustomFieldsEmpty: 'Noch keine benutzerdefinierten Felder hinzugefügt.',
  smartPlaylistCustomFieldsInvalid: 'Verwende einen Namen ohne Leerzeichen, der mit einem Buchstaben beginnt (zum Beispiel mood_energy). Reservierte Namen wie sort oder limit sind nicht erlaubt.',
  smartPlaylistCustomFieldsDuplicate: 'Dieses Feld steht bereits in der Liste.',
  smartPlaylistCustomFieldsRemove: '{{name}} entfernen',
  ...
  playQueueSyncTitle: 'Wiedergabewarteschlange synchronisieren',
  playQueueSyncDesc: 'Synchronisiert Warteschlange und Wiedergabeposition dieses Geräts mit dem Server, um auf einem anderen Gerät fortzufahren. Deaktivieren, um die Warteschlange lokal zu halten.',
  integrationsPrivacyBody: 'Alle Integrationen auf diesem Tab sind <strong>optional</strong> und senden, sobald aktiviert, Daten an externe Dienste oder an deinen Navidrome-Server. Last.fm erhält deinen Wiedergabeverlauf, Discord zeigt den aktuell laufenden Track in deinem Profil an, Bandsintown wird pro Künstler für Tour-Daten abgefragt, und der „Jetzt läuft"-Hinweis veröffentlicht deinen aktuellen Titel für andere Benutzer deines Navidrome-Servers. Wer das nicht möchte, lässt den jeweiligen Abschnitt einfach deaktiviert.',
  ...
  favoritesLayoutTitle: 'Favoritenseiten-Abschnitte',
  favoritesLayoutDesc: 'Per Drag & Drop neu anordnen, einzelne Abschnitte der Favoritenseite ein- oder ausblenden. Abschnitte ohne Favoriten werden automatisch übersprungen.',
  favoritesLayoutReset: 'Zurücksetzen',
  ...
  backupCredentialsNoticeTitle: 'Backups enthalten Passwörter',
  backupCredentialsNoticeBody: 'Einstellungs- und Komplett-Backups speichern Serverpasswörter und Scrobbler-Schlüssel als lesbaren Text — nur so kann eine Wiederherstellung die Anmeldungen zurückbringen. Wer die Datei öffnet, kann sie lesen: sicher aufbewahren und nicht weitergeben.',
  backupExport: 'Einstellungen exportieren',
  backupExportDesc: 'Speichert alle Einstellungen, Serverprofile, Last.fm-Konfiguration, Theme, EQ und Tastenkürzel in eine .psybkp-Datei. Passwörter werden im Klartext gespeichert — Datei sicher aufbewahren. Heruntergeladene Musik, Zwischenspeicher und ein angeschlossenes Sync-Gerät sind nicht enthalten.',
