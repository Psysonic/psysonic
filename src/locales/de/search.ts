export const search = {
  ...
  scopeFavoritesPlaceholder: 'Favoriten durchsuchen…',
  scopeFavoritesBadgeTooltip: 'Klicken — entfernen',
  scopeFavoritesGhostTooltip: 'Klicken — nur auf dieser Seite suchen',
