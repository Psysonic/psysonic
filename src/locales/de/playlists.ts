export const playlists = {
  ...
  smartReadOnlyEmpty: 'Diese Smart Playlist enthält keine passenden Titel.',
  title: 'Playlists',
  ...
  refreshSmart: 'Smart Playlist aktualisieren',
  refreshSmartSuccess: 'Smart Playlist aktualisiert',
  refreshSmartError: 'Smart Playlist konnte nicht aktualisiert werden',
