export const search = {
  ...
  scopeFavoritesPlaceholder: 'Rechercher dans les favoris…',
  scopeFavoritesBadgeTooltip: 'Clic — retirer',
  scopeFavoritesGhostTooltip: 'Clic — rechercher sur cette page seulement',
