export const playlists = {
  ...
  smartReadOnlyEmpty: 'Cette playlist intelligente ne contient aucun titre correspondant.',
  title: 'Playlists',
  ...
  refreshSmart: 'Actualiser la playlist intelligente',
  refreshSmartSuccess: 'Playlist intelligente actualisée',
  refreshSmartError: 'Impossible d’actualiser la playlist intelligente',
  ...
  listSort: {
    label: 'Trier les playlists',
    name: 'Nom (A–Z)',
    created: 'Créées récemment',
