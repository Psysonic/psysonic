export const settings = {
  ...
  discordCoverDesc: 'Ce que votre profil Discord peut afficher comme pochette. « Aucune (icône de l’application uniquement) » ne publie rien. Les autres options transmettent des URL d’images au proxy d’images de Discord : toute personne consultant votre profil peut voir l’adresse publique de votre serveur, et les pochettes du serveur nécessitent un serveur accessible publiquement. Les sources de pochettes de l’application, ci-dessous, sont indépendantes.',
  discordCoverNone: 'Aucune (icône de l\'app uniquement)',
  discordCoverServer: 'Suivre les sources de l’application',
  discordCoverApple: 'Sources externes uniquement (aucune URL de serveur)',
  coverSourceSectionTitle: 'Pochettes d’album',
  coverSourceTitle: 'Sources des pochettes',
  coverSourceDesc: 'D’où proviennent les pochettes lorsque le serveur n’en a pas. L’ordre va de haut en bas ; la première source activée qui renvoie une image l’emporte. Faites glisser pour réordonner, ou désactivez une source pour l’ignorer.',
  coverSourceServer: 'Serveur (informations de l’album)',
  ...
  lyricsPronunciationTitle: 'Prononciation',
  lyricsRomanization: 'Prononciation et rōmaji japonais',
  lyricsRomanizationDesc: 'Affiche la prononciation fournie par le serveur sous les paroles ou génère localement du rōmaji Hepburn pour le texte japonais.',
  lyricsWordHighlightTitle: 'Surlignage des mots',
  lyricsWordHighlightStep: 'Par étapes',
  ...
  favoritesLayoutTitle: 'Sections de la page Favoris',
  favoritesLayoutDesc: 'Glissez pour réorganiser, basculez pour masquer des sections individuelles de la page Favoris. Les sections sans favoris sont ignorées automatiquement.',
  favoritesLayoutReset: 'Réinitialiser',
  ...
  backupExportDesc: 'Enregistre tous les paramètres, profils serveur, configuration Last.fm, thème, EQ et raccourcis dans un fichier .psybkp. Les mots de passe sont stockés en clair — conservez le fichier en sécurité. La musique téléchargée, les caches et un appareil de synchronisation connecté ne sont pas inclus.',
  ...
  smartPlaylistCustomFieldsTitle: 'Champs personnalisés des playlists intelligentes',
  smartPlaylistCustomFieldsDesc: 'Ajoutez des tags et des rôles propres au serveur dans le sélecteur de champs Avancé des playlists intelligentes. Les champs Navidrome intégrés et les tags par défaut de mappings.yaml sont déjà répertoriés. Nécessite Navidrome 0.55+.',
  smartPlaylistCustomFieldsList: 'Champs personnalisés',
  smartPlaylistCustomFieldsEmpty: 'Aucun champ personnalisé ajouté pour l’instant.',
  smartPlaylistCustomFieldsInvalid: 'Utilisez un nom commençant par une lettre et sans espaces (par exemple mood_energy). Les noms réservés comme sort ou limit ne peuvent pas être utilisés.',
  smartPlaylistCustomFieldsDuplicate: 'Ce champ figure déjà dans la liste.',
  smartPlaylistCustomFieldsRemove: 'Supprimer {{name}}',
